...
if (Constant::MODE_CREATE == $mode || Constant::MODE_MODIFY == $mode) {
    ...
    if (Constant::MODE_CREATE == $mode || (Constant::MODE_MODIFY == $mode && $ids != DEFAULT_VALUE_BLANK)) {
        ...
        foreach ($ary as $id) {
            ...
            if (SessionUtility::getValue(SessionUtility::OBJECT_NAME_ADMINISTRATOR) == Constant::FLAG_YES_DATABASE) {
            ...
            if (Constant::MODE_MODIFY == $mode) {
                ...
                $textRegistrationDate = new FormBase(debug: SessionUtility::getValue(SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: true, id: REGISTRATION_DATE_FIELD_NAME . "_" . $id, name: REGISTRATION_DATE_FIELD_NAME . "_" . $id, suffix: NULL, value: DateTimeUtility::formatDisplayDateTime(value: $registrationDateTime));
                ...
                $textApprovalDate = new FormBase(debug: SessionUtility::getValue(SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: true, id: APPROVAL_DATE_FIELD_NAME . "_" . $id, name: APPROVAL_DATE_FIELD_NAME . "_" . $id, suffix: NULL, value: NULL === $approvalDateTime ? NULL : DateTimeUtility::formatDisplayDateTime(value: $approvalDateTime));
                ...
                $textApprovalPlayer = new FormBase(debug: SessionUtility::getValue(SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: true, id: APPROVAL_PLAYER_FIELD_NAME . "_" . $id, name: APPROVAL_PLAYER_FIELD_NAME . "_" . $id, suffix: NULL, value: NULL === $resultList[$ctr]->getPlayerApproval() ? NULL : $resultList[$ctr]->getPlayerApproval()->getPlayerName());
                ...
                $textRejectionDate = new FormBase(debug: SessionUtility::getValue(SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: true, id: REJECTION_DATE_FIELD_NAME . "_" . $id, name: REJECTION_DATE_FIELD_NAME . "_" . $id, suffix: NULL, value: NULL === $rejectionDateTime ? NULL : DateTimeUtility::formatDisplayDateTime(value: $rejectionDateTime));
