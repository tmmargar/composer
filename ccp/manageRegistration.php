...
//                 player_id, name, player_email, tournament_max_players, player_active_flag
        ...
        if (0 < count($resultList)) {
            ...
            $resultListNested = $entityManager->getRepository(Constant::ENTITY_PLAYERS)->getFeeForPlayerAndTournament(playerId: $playerId, tournamentId: $tournaments->getTournamentId());
