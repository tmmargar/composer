...
define("GAME_TYPE_ID_FIELD_NAME", "limitTypeId");
define("GAME_TYPE_NAME_FIELD_NAME", "limitTypeName");
...
if (Constant::MODE_CREATE == $mode || Constant::MODE_MODIFY == $mode) {
  ...
  foreach ($ary as $id) {
    ...
    if (Constant::MODE_SAVE_CREATE == $mode) {
      ...
      $rowCount = $databaseResult->insertLimitType(params: $params);
    } elseif (Constant::MODE_SAVE_MODIFY == $mode) {
      $params = array($limitTypeId, $limitTypeName);
      $rowCount = $databaseResult->updateLimitType(params: $params);
    }
