...
if (Constant::MODE_CREATE == $mode || Constant::MODE_MODIFY == $mode) {
    ...
    if (Constant::MODE_CREATE == $mode || (Constant::MODE_MODIFY == $mode && DEFAULT_VALUE_BLANK != $ids)) {
        ...
        foreach ($ary as $id) {
            ...
            $textBoxName = new FormControl(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: Constant::ACCESSKEY_NAME, autoComplete: NULL, autoFocus: true, checked: NULL, class: NULL, cols: NULL, disabled: false, id: LIMIT_TYPE_NAME_FIELD_NAME . "_" . $id, maxLength: 50, name: LIMIT_TYPE_NAME_FIELD_NAME . "_" . $id, onClick: NULL, placeholder: NULL, readOnly: false, required: true, rows: NULL, size: 35, suffix: NULL, type: FormControl::TYPE_INPUT_TEXTBOX, value: ((count($resultList) > 0) ? $resultList[$ctr]->getLimitTypeName() : ""), wrap: NULL, noValidate: false);
