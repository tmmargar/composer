...
if (Constant::MODE_CREATE == $mode || Constant::MODE_MODIFY == $mode) {
    $tournaments = $entityManager->getRepository(entityName: Constant::ENTITY_TOURNAMENTS)->getById(tournamentId: (int) $ids);
    ...
    if (Constant::MODE_CREATE == $mode || (Constant::MODE_MODIFY == $mode && DEFAULT_VALUE_BLANK != $ids)) {
        ...
        foreach ($ary as $id) {
            ...
            $textBoxName = new FormControl(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: Constant::ACCESSKEY_COMMENT, autoComplete: NULL, autoFocus: false, checked: NULL, class: NULL, cols: NULL, disabled: false, id: TOURNAMENT_COMMENT_FIELD_NAME . "_" . $id, maxLength: 200, name: TOURNAMENT_COMMENT_FIELD_NAME . "_" . $id, onClick: NULL, placeholder: NULL, readOnly: false, required: false, rows: NULL, size: 20, suffix: NULL, type: FormControl::TYPE_INPUT_TEXTBOX, value: ((NULL !== $tournaments) ? $tournaments->getTournamentComment() : ""), wrap: NULL, noValidate: false);
            $output .= " <div class=\"responsive-cell responsive-cell-value\">" . $textBoxName->getHtml() . "</div>";
            $limitTypes = $entityManager->getRepository(entityName: Constant::ENTITY_LIMIT_TYPES)->getById(limitTypeId: NULL);
            if (NULL !== $limitTypes) {
                ...
                $selectLimitType = new FormSelect(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: Constant::ACCESSKEY_LIMIT_TYPE, class: NULL, disabled: false, id: TOURNAMENT_LIMIT_TYPE_ID_FIELD_NAME . "_" . $id, multiple: false, name: TOURNAMENT_LIMIT_TYPE_ID_FIELD_NAME . "_" . $id, onClick: NULL, readOnly: false, size: 1, suffix: NULL, value: NULL);
                $output .= " <div class=\"responsive-cell responsive-cell-value\">" . $selectLimitType->getHtml();
                $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments ? $tournaments->getLimitTypes()->getLimitTypeId() : "", suffix: NULL, text: Constant::TEXT_NONE, value: DEFAULT_VALUE_BLANK);
                $output .= $option->getHtml();
                foreach ($limitTypes as $limitType) {
                    $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments ? $tournaments->getLimitTypes()->getLimitTypeId() : "", suffix: NULL, text: $limitType->getLimitTypeName(), value: $limitType->getLimitTypeId());
                    $output .= $option->getHtml();
                }
                $output .= "     </select>\n";
                $output .= "    </div>\n";
            }
            $gameTypes = $entityManager->getRepository(entityName: Constant::ENTITY_GAME_TYPES)->getById(gameTypeId: NULL);
            if (NULL !== $gameTypes) {
                ...
                $selectLimitType = new FormSelect(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: Constant::ACCESSKEY_GAME_TYPE, class: NULL, disabled: false, id: TOURNAMENT_GAME_TYPE_ID_FIELD_NAME . "_" . $id, multiple: false, name: TOURNAMENT_GAME_TYPE_ID_FIELD_NAME . "_" . $id, onClick: NULL, readOnly: false, size: 1, suffix: NULL, value: NULL);
                $output .= " <div class=\"responsive-cell responsive-cell-value\">" . $selectLimitType->getHtml();
                $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments ? $tournaments->getGameTypes()->getGameTypeId() : "", suffix: NULL, text: Constant::TEXT_NONE, value: DEFAULT_VALUE_BLANK);
                $output .= $option->getHtml();
                foreach ($gameTypes as $gameType) {
                    $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments ? $tournaments->getGameTypes()->getGameTypeId() : "", suffix: NULL, text: $gameType->getGameTypeName(), value: $gameType->getGameTypeId());
                    $output .= $option->getHtml();
                }
                $output .= "     </select>\n";
                $output .= "    </div>\n";
            }
            $specialTypes = $entityManager->getRepository(entityName: Constant::ENTITY_SPECIAL_TYPES)->getById(specialTypeId: NULL);
            if (NULL !== $specialTypes) {
                ...
                $selectSpecialType = new FormSelect(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: Constant::ACCESSKEY_SPECIAL_TYPE, class: NULL, disabled: false, id: TOURNAMENT_SPECIAL_TYPE_ID_FIELD_NAME . "_" . $id, multiple: false, name: TOURNAMENT_SPECIAL_TYPE_ID_FIELD_NAME . "_" . $id, onClick: NULL, readOnly: false, size: 1, suffix: NULL, value: NULL);
                $output .= " <div class=\"responsive-cell responsive-cell-value\">" . $selectSpecialType->getHtml();
                $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments && NULL !== $tournaments->getSpecialTypes() ? $tournaments->getSpecialTypes()->getSpecialTypeId() : "", suffix: NULL, text: Constant::TEXT_NONE, value: DEFAULT_VALUE_BLANK);
                $output .= $option->getHtml();
            ...
            $locations = $entityManager->getRepository(entityName: Constant::ENTITY_LOCATIONS)->getById(locationId: NULL);
            if (NULL !== $locations) {
                ...
                $selectLocation = new FormSelect(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: Constant::ACCESSKEY_LOCATION_NAME, class: NULL, disabled: false, id: TOURNAMENT_LOCATION_ID_FIELD_NAME . "_" . $id, multiple: false, name: TOURNAMENT_LOCATION_ID_FIELD_NAME . "_" . $id, onClick: NULL, readOnly: false, size: 1, suffix: NULL, value: NULL);
                $output .= " <div class=\"responsive-cell responsive-cell-value\">" . $selectLocation->getHtml();
                $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments ? $tournaments->getLocations()->getLocationId() : "", suffix: NULL, text: Constant::TEXT_NONE, value: DEFAULT_VALUE_BLANK);
                $output .= $option->getHtml();
                foreach ($locations as $location) {
                    $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments ? $tournaments->getLocations()->getLocationId() : "", suffix: NULL, text: $location->getLocationName(), value: $location->getLocationId());
                    $output .= $option->getHtml();
                }
                $output .= "     </select>\n";
                $output .= "    </div>\n";
            ...
            $textBoxName = new FormControl(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: Constant::ACCESSKEY_ADDON_CHIP_COUNT, autoComplete: NULL, autoFocus: false, checked: NULL, class: NULL, cols: NULL, disabled: false, id: TOURNAMENT_ADDON_CHIP_COUNT_FIELD_NAME . "_" . $id, maxLength: 5, name: TOURNAMENT_ADDON_CHIP_COUNT_FIELD_NAME . "_" . $id, onClick: NULL, placeholder: NULL, readOnly: false, required: true, rows: NULL, size: 5, suffix: NULL, type: FormControl::TYPE_INPUT_NUMBER, value: ((NULL !== $tournaments) ? (string) $tournaments->getTournamentAddonChipCount() : ""), wrap: NULL, noValidate: false);
            $output .= " <div class=\"responsive-cell responsive-cell-value\">" . $textBoxName->getHtml() . " (# >= 0)</div>\n";
            $groups = $entityManager->getRepository(entityName: Constant::ENTITY_GROUPS)->getById(groupId: NULL);
            if (NULL !== $groups) {
                ...
                $selectGroup = new FormSelect(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: Constant::ACCESSKEY_GROUP, class: NULL, disabled: false, id: TOURNAMENT_GROUP_ID_FIELD_NAME . "_" . $id, multiple: false, name: TOURNAMENT_GROUP_ID_FIELD_NAME . "_" . $id, onClick:NULL, readOnly: false, size: 1, suffix: NULL, value: NULL);
                $output .= " <div class=\"responsive-cell responsive-cell-value\">" . $selectGroup->getHtml();
                $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments ? $tournaments->getGroups()->getGroupId() : "", suffix: NULL, text: Constant::TEXT_NONE, value: DEFAULT_VALUE_BLANK);
                $output .= $option->getHtml();
                foreach ($groups as $group) {
                    $option = new FormOption(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), class: NULL, disabled: false, id: NULL, name: NULL, selectedValue: NULL !== $tournaments ? $tournaments->getGroups()->getGroupId() : "", suffix: NULL, text: $group->getGroupName(), value: $group->GetGroupId());
                    $output .= $option->getHtml();
                }
                $output .= "     </select>\n";
                $output .= "    </div>\n";
        ...
        $tournaments = $entityManager->getRepository(entityName: Constant::ENTITY_TOURNAMENTS)->getCountForDates(startDate: $season->getSeasonStartDate(), endDate: $season->getSeasonEndDate());
        $hiddenCountTournament = new FormControl(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), accessKey: NULL, autoComplete: NULL, autoFocus: false, checked: NULL, class: NULL, cols: NULL, disabled: false, id: "countTournament", maxLength: NULL, name: "countTournament", onClick: NULL, placeholder: NULL, readOnly: false, required: NULL, rows: NULL, size: NULL, suffix: NULL, type: FormControl::TYPE_INPUT_HIDDEN, value: count($tournaments), wrap: NULL, noValidate: false);
        $output .= $hiddenCountTournament->getHtml();
        $output .= " <div class=\"buttons center\">\n";
    ...
    foreach ($ary as $id) {
        ...
        if (Constant::MODE_SAVE_CREATE == $mode) {
            $to = new Tournaments();
            $gameType = $entityManager->find(className: Constant::ENTITY_GAME_TYPES, id: $tournamentGameTypeId);
            $to->setGameTypes(gameTypes: $gameType);
            $group = $entityManager->find(className: Constant::ENTITY_GROUPS, id: $tournamentGroupId);
            $to->setGroups(groups: $group);
            $limitType = $entityManager->find(className: Constant::ENTITY_LIMIT_TYPES, id: $tournamentLimitTypeId);
            $to->setLimitTypes(limitTypes: $limitType);
            $location = $entityManager->find(className: Constant::ENTITY_LOCATIONS, id: $tournamentLocationId);
            $to->setLocations(locations: $location);
            $st = $entityManager->find(className: Constant::ENTITY_SPECIAL_TYPES, id: $tournamentSpecialTypeId);
            $to->setSpecialTypes($st);
            $to->setTournamentAddonAmount(tournamentAddonAmount: $tournamentAddonAmount);
            $to->setTournamentAddonChipCount(tournamentAddonChipCount: $tournamentAddonChipCount);
            $to->setTournamentBuyinAmount(tournamentBuyinAmount: $tournamentBuyinAmount);
            $to->setTournamentChipCount(tournamentChipCount: $tournamentChipCount);
            $to->setTournamentComment(tournamentComment: $tournamentComment);
            $to->setTournamentDate(tournamentDate: new DateTime(datetime: $tournamentDate));
            $to->setTournamentDescription(tournamentDescription: $tournamentDescription);
            $to->setTournamentMap(tournamentMap: $tournamentMap);
            $to->setTournamentMaxPlayers(tournamentMaxPlayers: $tournamentMaxPlayers);
            $to->setTournamentMaxRebuys(tournamentMaxRebuys: $tournamentMaxRebuys);
            $to->setTournamentRake(tournamentRake: (string) ($tournamentRake / 100));
            $to->setTournamentRebuyAmount(tournamentRebuyAmount: $tournamentRebuyAmount);
            $to->setTournamentStartTime(tournamentStartTime: new DateTime(datetime: $tournamentStartTime));
            $entityManager->persist(entity: $to);
            $entityManager->flush();
            // check if first tournament for season if so add fees
            $resultList = $entityManager->getRepository(entityName: Constant::ENTITY_SEASONS)->getForTournament(tournamentId: $to->getTournamentId());
            if (count($resultList) > 0) {
                $resultList2 = $entityManager->getRepository(entityName: Constant::ENTITY_TOURNAMENTS)->getMinDateTime(seasonId: (int) $resultList[0]["season_id"]);
                $resultList3 = $entityManager->getRepository(entityName: Constant::ENTITY_TOURNAMENTS)->getForDateAndTime(tournamentDate: new DateTime(datetime: $resultList2[0]["tournamentDate"]), time: new DateTime(datetime: $resultList2[0]["tournamentStartTime"]));
                if ($to->getTournamentId() == $resultList3[0]->getTournamentId()) {
                    $rowCount = $entityManager->getRepository(entityName: Constant::ENTITY_FEES)->insertForSeasonAndTournament(seasonId: (int) $resultList[0]["season_id"], tournamentId: $resultList3[0]->getTournamentId());
                }
            }
        } elseif (Constant::MODE_SAVE_MODIFY == $mode) {
            $to = $entityManager->getRepository(entityName: Constant::ENTITY_TOURNAMENTS)->getById(tournamentId: (int) $tournamentId);
            $gameType = $entityManager->find(className: Constant::ENTITY_GAME_TYPES, id: $tournamentGameTypeId);
            $to->setGameTypes(gameTypes: $gameType);
            $group = $entityManager->find(className: Constant::ENTITY_GROUPS, id: $tournamentGroupId);
            $to->setGroups(groups: $group);
            ...
            if (isset($params[0]) || isset($params[1]) || isset($params[2]) || isset($params[3])) {
                $rowCount = $entityManager->getRepository(entityName: Constant::ENTITY_RESULTS)->updateFinish(rebuyCount: $params[0], rebuyPaidFlag: $params[1], addonPaidFlag: $params[2], addonFlag: $params[3], statusCode: NULL, place: NULL, playerIdKo: NULL, tournamentId: $tournamentId, playerId: NULL);
...
if (Constant::MODE_MODIFY == $mode || Constant::MODE_DELETE == $mode) {
    $resultsExist = 0;
    $resultList = $entityManager->getRepository(entityName: Constant::ENTITY_RESULTS)->getPaidOrRegisteredOrFinished(tournamentId: (int) $ids, playerId: NULL, paid: false, registered: false, finished: true, indexed: false);
    if (count(value: $resultList) > 0) {
        $resultsExist = Constant::FLAG_YES_DATABASE;
    }
    $hiddenResultsExist = new FormControl(SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), NULL, NULL, false, NULL, NULL, NULL, false, TOURNAMENT_RESULTS_EXIST_FIELD_NAME, NULL, TOURNAMENT_RESULTS_EXIST_FIELD_NAME, NULL, NULL, false, NULL, NULL, NULL, NULL, FormControl::TYPE_INPUT_HIDDEN, (string) $resultsExist, NULL, noValidate: false);
    $output .= $hiddenResultsExist->getHtml();
}
if (Constant::MODE_VIEW == $mode || Constant::MODE_DELETE == $mode || Constant::MODE_CONFIRM == $mode) {
    if (Constant::MODE_CONFIRM == $mode) {
        if ($ids != DEFAULT_VALUE_BLANK) {
            $resultList = $entityManager->getRepository(entityName: Constant::ENTITY_FEES)->getForTournament(tournamentId: (int) $ids, greaterThanZero: true);
            if (count(value: $resultList) > 0) {
                $output .=
                    "<script type=\"module\">\n" .
                    "  import { dataTable, display, input } from \"./scripts/import.js\";\n" .
                ...
                $rowCount = $entityManager->getRepository(entityName: Constant::ENTITY_RESULTS)->deleteForTournament(tournamentId: (int) $ids);
                $tournaments = $entityManager->getRepository(entityName: Constant::ENTITY_TOURNAMENTS)->getById(tournamentId: (int) $ids);
                $entityManager->remove(entity: $tournaments);
                try {
                    $entityManager->flush();
                } catch (Exception $e) {
                    $errors = $e->getMessage();
    ...
    $output .= $hiddenSelectedRows->getHtml();
    $id = ("" == $ids) ? NULL : (int) $ids;
    $result = $entityManager->getRepository(entityName: Constant::ENTITY_TOURNAMENTS)->getTableOutput(tournamentId: $id, indexed: true);
    $resultHeaders = $entityManager->getRepository(entityName: Constant::ENTITY_TOURNAMENTS)->getTableOutput(tournamentId: $id, indexed: false);
