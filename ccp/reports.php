...
if (!isset($reportId)) {
    ...
    switch ($reportId) {
        ...
        case REPORT_ID_KNOCKOUTS:
            ...
            break;
        case REPORT_ID_SUMMARY:
            $result = $entityManager->getRepository(Constant::ENTITY_RESULTS)->getOrderedSummary(currentDate: new DateTime(), startDate: $startDate, endDate: $endDate, championship: $championship, stats: false, email: false, indexed: true);
            $resultHeaders = $entityManager->getRepository(Constant::ENTITY_RESULTS)->getOrderedSummary(currentDate: new DateTime(), startDate: $startDate, endDate: $endDate, championship: $championship, stats: false, email: false, indexed: false);
