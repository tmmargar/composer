...
foreach ($resultList as $row) {
    ...
    $registrationOpenDate = new \Poker\Ccp\classes\model\DateTime(debug: SessionUtility::getValue(SessionUtility::OBJECT_NAME_DEBUG), id: NULL, time: $tournament->getDate()->getDatabaseFormat() . " " . $tournament->getRegistrationOpen()->getDisplayAmPmFormat());
