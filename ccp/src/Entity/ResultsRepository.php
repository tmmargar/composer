...
//         case "resultAllOrderedSummaryStats":
    ...
    public function updateFinish(?int $rebuyCount, ?string $rebuyPaidFlag, ?string $addonPaidFlag, ?string $addonFlag, ?string $statusCode, ?int $place, ?int $playerIdKo, int $tournamentId, ?int $playerId): int {
        $sql =
            ...
            "SET " . (isset($rebuyCount) ? "result_rebuy_count = ?" : "") .
            (isset($rebuyPaidFlag) ? (isset($rebuyCount) ? ", " : "") . "result_paid_rebuy_flag = ?" : "") .
            (isset($addonPaidFlag) ? (isset($rebuyPaidFlag) || isset($rebuyCount) ? ", " : "") . "result_paid_addon_flag = ?" : "") .
            (isset($addonFlag) ? (isset($addonPaidFlag) || isset($rebuyPaidFlag) || isset($rebuyCount) ? ", " : "") . "result_addon_flag = ?" : "") .
            (isset($statusCode) ? (isset($addonFlag) || isset($addonPaidFlag) || isset($rebuyPaidFlag) || isset($rebuyCount) ? ", " : "") . "status_code = ?" : "") .
            (isset($place) ? (isset($statusCode) || isset($addonFlag) || isset($addonPaidFlag) || isset($rebuyPaidFlag) || isset($rebuyCount) ? ", " : "") . "result_place_finished = ?" : "") .
            (isset($playerIdKo) ? (isset($place) || isset($statusCode) || isset($addonFlag) || isset($addonPaidFlag) || isset($rebuyPaidFlag) || isset($rebuyCount) ? ", " : "") . "player_id_ko = ?" : "") .
            " WHERE tournament_id = ?";
            if (isset($playerId)) {
                $sql .= " AND player_id = ?";
            }
