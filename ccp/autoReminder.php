...
if (count($resultList2) == 0) {
    ...
    foreach ($resultList as $player) {
        foreach ($resultList2 as $tournaments) {
            ...
            $location = new Location(debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), id: $row["location_id"], name: $row["location"], address: "", city: "", state: "", zipCode: 00000, player: $playerLocation, count: 0, active: "0", map: NULL, mapName: NULL, tournamentCount: 0);
