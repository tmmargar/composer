...
$htmlLinkFees = new HtmlLink(accessKey: NULL, class: NULL, debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), href: "reports.php", id: NULL, paramName: array("reportId"), paramValue: array("fees","show"), tabIndex: - 1, text: "Fees", title: NULL);
...
$htmlLinkByNameByEarnings = new HtmlLink(accessKey: NULL, class: NULL, debug: SessionUtility::getValue(name: SessionUtility::OBJECT_NAME_DEBUG), href: "reports.php", id: NULL, paramName: array("reportId","sort","group"), paramValue: array("championship","2 down,1 up","true"), tabIndex: - 1, text: "By name by earnings", title: NULL);
